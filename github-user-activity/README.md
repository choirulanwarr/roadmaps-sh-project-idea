...
- Fetch the recent activity of the specified GitHub user using the GitHub API. You can use the following endpoint to fetch the user's activity:
    ...
    # Example: https://api.github.com/users/choirulanwarr/events
    ```
- Display the fetched activity in the terminal.
    ```javascript
    Output:
    - Pushed 3 commits to choirulanwarr/roadmaps-sh-project-idea
    - Opened a new issue in choirulanwarr/roadmaps-sh-project-idea
    - Starred choirulanwarr/roadmaps-sh-project-idea
    - ...
    ```
